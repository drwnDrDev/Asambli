...
class AccesoReunionNotification extends Notification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line("Estás invitado a:")
            ->line("**{$this->reunion->titulo}**")
            ->line("Fecha: {$fecha}")
            ->line("---")
            ->line("**Tu PIN de acceso es: {$this->pin}**")
            ->line("Guarda este PIN — lo necesitarás junto con tu número de documento para ingresar.")
            ->action('Ir a la reunión', $loginUrl)
